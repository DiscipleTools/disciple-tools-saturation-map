...
class DT_Saturation_Heatmap {
    ...
    public static function clear_practitioner_grid_totals() {
        delete_transient( 'DT_Saturation_Heatmap::query_practitioner_grid_totals' );
        delete_transient( 'DT_Saturation_Heatmap::query_practitioner_grid_totalsa0' );
        delete_transient( 'DT_Saturation_Heatmap::query_practitioner_grid_totalsa1' );
        delete_transient( 'DT_Saturation_Heatmap::query_practitioner_grid_totalsa2' );
        delete_transient( 'DT_Saturation_Heatmap::query_practitioner_grid_totalsa3' );
        delete_transient( 'DT_Saturation_Heatmap::query_practitioner_grid_totalsa4' );
        delete_transient( 'DT_Saturation_Heatmap::query_practitioner_grid_totalsworld' );
        delete_transient( 'DT_Saturation_Heatmap::query_practitioner_grid_totalsfull' );
    }
...
//        }
    ...
    public static function clear_church_grid_totals() {
        delete_transient( 'DT_Saturation_Heatmap::query_church_grid_totals' );
        delete_transient( 'DT_Saturation_Heatmap::query_church_grid_totalsa0' );
        delete_transient( 'DT_Saturation_Heatmap::query_church_grid_totalsa1' );
        delete_transient( 'DT_Saturation_Heatmap::query_church_grid_totalsa2' );
        delete_transient( 'DT_Saturation_Heatmap::query_church_grid_totalsa3' );
        delete_transient( 'DT_Saturation_Heatmap::query_church_grid_totalsa4' );
        delete_transient( 'DT_Saturation_Heatmap::query_church_grid_totalsworld' );
        delete_transient( 'DT_Saturation_Heatmap::query_church_grid_totalsfull' );
    }
    ...
    public static function query_orgs_grid_totals( $administrative_level = null ) {
        ...
        switch ( $administrative_level ) {
            case 'a0':
                $results = $wpdb->get_results( "
                    ...
                    FROM (
                        SELECT lg.admin0_grid_id, lg.admin1_grid_id, lg.admin2_grid_id, lg.admin3_grid_id, lg.admin4_grid_id, lg.admin5_grid_id
                        FROM $wpdb->dt_reports as dtr
                        LEFT JOIN $wpdb->dt_location_grid as lg ON dtr.grid_id=lg.grid_id
                        WHERE dtr.type = 'saturation_app'
                    ) as t0
                    GROUP BY t0.admin0_grid_id
                    ", ARRAY_A );
                break;
...
function zume_public_log_actions( $activity_log ){
    ...
    foreach ( $activity_log as $index => $log ){
        ...
        if ( 'studying' === substr( $log['action'], 0, 8 ) ) {
            $initials = DT_Saturation_Heatmap::create_initials( $log['lng'], $log['lat'], $log['payload'] );
