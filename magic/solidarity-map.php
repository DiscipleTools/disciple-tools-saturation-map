...
if ( strpos( dt_get_url_path(), 'saturation_app' ) !== false || dt_is_rest() ){
    DT_Saturation_Map::instance();
}

class DT_Saturation_Map extends DT_Magic_Url_Base
{
    public $page_title = 'Solidarity Map';
    public $root = "saturation_app";
    public $type = 'solidarity_map';
    public $type_name = '';
    ...
    public function endpoint( WP_REST_Request $request ) {
        ...
        switch ( $action ) {
            ...
            case 'a0':
            case 'world':
                $list = DT_Saturation_Heatmap::query_church_grid_totals( $action );
            ...
            case 'grid_data':
                $grid_totals = DT_Saturation_Heatmap::query_church_grid_totals();
