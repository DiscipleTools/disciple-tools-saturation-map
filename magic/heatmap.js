      ...
      .done(function (geojson) {
        ...
        map.on('load', function() {
          ...
          map.on('click', i.toString()+'fills', function (e) {
            ...
            let ac = $('#report-content')
            // ac.html('<span class="loading-spinner active"></span>')
            ac.empty()
            ac.append(`<div><button class="button button-primary"><i class="fi-plus"></i></button> People Groups</div>`)
            ac.append(`<div><button class="button button-primary"><i class="fi-plus"></i></button> Bibles</div>`)
            ac.append(`<div><button class="button button-primary"><i class="fi-plus"></i></button> Churches</div>`)
            ac.append(`<div><button class="button button-primary"><i class="fi-plus"></i></button> Proclamation</div>`)
            ac.append(`<div><button class="button button-primary"><i class="fi-plus"></i></button></div>`)
