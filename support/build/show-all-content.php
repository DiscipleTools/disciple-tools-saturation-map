...
class DT_Saturation_Map_Show_All extends DT_Magic_Url_Base
{
    ...
    public function header_javascript(){
        require_once( WP_CONTENT_DIR . '/plugins/disciple-tools-saturation-map/pages/assets/header.php' );
        ?>
        <link href="https://fonts.googleapis.com/css?family=Crimson+Text:400,400i,600|Montserrat:200,300,400" rel="stylesheet">
        <link rel="stylesheet" href="<?php echo esc_url( WP_CONTENT_URL . '/plugins/disciple-tools-saturation-map/pages/' ) ?>assets/fonts/ionicons/css/ionicons.min.css">
        <link rel="stylesheet" href="<?php echo esc_url( WP_CONTENT_URL . '/plugins/disciple-tools-saturation-map/pages/' ) ?>assets/basic.css?ver=<?php echo esc_attr( fileatime( WP_CONTENT_DIR . '/plugins/disciple-tools-saturation-map/pages/assets/basic.css' ) ) ?>" type="text/css" media="all">
        <?php
    }

    public function footer_javascript(){
        require_once( WP_CONTENT_DIR . '/plugins/disciple-tools-saturation-map/pages/assets/footer.php' );
    }
...
//        $lists = PG_Stacker_Text_V2::_cities($lists, $stack, true );
        ...
        require_once( WP_CONTENT_DIR . '/plugins/disciple-tools-saturation-map/pages/assets/nav.php' ) ?>
        ...
        <?php require_once( WP_CONTENT_DIR . '/plugins/disciple-tools-saturation-map/pages/assets/working-footer.php' ) ?>
        <?php
    }
