[![Build Status](https://travis-ci.com/Pray4Movement/disciple-tools-saturation-map.svg?branch=master)](https://travis-ci.com/Pray4Movement/disciple-tools-saturation-map)
...
#### Framework
 ...
 1. Disciple.Tools Theme presence check. ```disciple_tools_saturation_map()```
...
[Issues](https://github.com/Pray4Movement/disciple-tools-saturation-map/issues) section of the repo. You can present ideas
in the [Discussions](https://github.com/Pray4Movement/disciple-tools-saturation-map/discussions) section of the repo. And
code contributions are welcome using the [Pull Request](https://github.com/Pray4Movement/disciple-tools-saturation-map/pulls)
system for git. For a more details on contribution see the
[contribution guidelines](https://github.com/Pray4Movement/disciple-tools-saturation-map/blob/master/CONTRIBUTING.md).
